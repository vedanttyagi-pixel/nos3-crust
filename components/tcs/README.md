# Tcs - NOS3 Component
This repository contains the NOS3 Tcs Component.
This includes flight software (FSW), ground software (GSW), simulation, and support directories.

## Component Template
This component template utilizes canned files from the existing [tcs component](https://github.com/nasa-itc/tcs) to generate a new component to do development in.
...
## Overview
In addition to being used by the template generator, the tcs component provides an executable example for the user.
This tcs component is a UART device that accepts multiple commands, including requests for telemetry and data.
The available FSW is for use in the core Flight System (cFS) while the GSW supports COSMOS.
A NOS3 simulation is available which includes both tcs and 42 data providers.
...
## FSW
Refer to the file [fsw/platform_inc/tcs_platform_cfg.h](fsw/platform_inc/tcs_platform_cfg.h) for the default
...
<simulator>
    <name>tcs_sim</name>
    <active>true</active>
    <library>libtcs_sim.so</library>
    <hardware-model>
        <type>TCS</type>
        <connections>
            <connection><type>command</type>
                <bus-name>command</bus-name>
                <node-name>tcs-sim-command-node</node-name>
            </connection>
...
* make
* make checkout
  * Launches NOS Engine, NOS Time Driver, NOS Terminal, Tcs Sim, and Tcs Checkout
* make stop

# Documentation
If this tcs application had an ICD and/or test procedure, they would be linked here.
