 ...
 *
 * Purpose:
 * Extra scaffolding functions for the tcs_app unit test
 *
 * Notes:
 ...
 * "TCS_APP_Data_t" typedef.
 */
#include "tcs_app.h"

/*
 * Allow UT access to the global "TCS_APP_Data" object.
 */
// extern TCS_AppData_t TCS_APP_Data;
