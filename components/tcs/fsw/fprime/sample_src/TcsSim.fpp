module Components {
    ...
    active component TcsSim {
        ...
        @ Command to initialize Sequence Tcs HK
        async command TCS_SEQ(
        )
        ...
        @ A Count of Successful Commands from FSW to Tcs
        telemetry CommandCount: U32

        @ A Count of Unsuccessful Commands from FSW to Tcs
